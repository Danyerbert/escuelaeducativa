...
$sql = "SELECT u.id, u.usuario, u.password, u.cargo, p.nombre FROM usuarios AS u
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <?php echo " <li><a class= 'dropdown-item ' href= 'editusuario.php?id=" . $row['id'] . "'><img src='img/svg/editar.svg' alt='Dr. Manuel Diaz Rodriguez' width='15' height='15'> Editar</a></li>" ?>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
