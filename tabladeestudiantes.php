...
$sql = "SELECT a.nombre, a.apellido, a.fecha_nac, a.turno, a.telefono, a.parentesco, a.edad, a.cedula_estudiante, g.grado FROM datos_alumnos AS a INNER JOIN grados AS g ON  a.id_grado = g.id_grado";
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="registrodeestudiantes.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#exampleModal"> Registrar Alumnos</a>
                    </div>
                    <div class="card mb-4">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <?php echo " <li><a class= 'dropdown-item ' href= 'editaralumno.php?id=" . $row['id_alumno'] . "'><img src='img/svg/editar.svg' alt='Dr. Manuel Diaz Rodriguez' width='15' height='15'> Editar</a></li>" ?>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
