...
if ($_POST) {
    ...
    $sql = "INSERT INTO profesores (nombre, telefono,  grado, correo, turno, seccion) VALUES ('$nombre','$phone','$grado','$correo','$turno','$seccion')";
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        if ($tipo_usuario == 1) { ?>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse1" data-bs-target="#pagesCollapseAuth" aria-expanded="false" aria-controls="pagesCollapseAuth">
                                        Profesor
                                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                    </a>
                                    <div class="collapse1" id="pagesCollapseAuth1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="tabladeprofesores.php">Listado de Estudiantes</a>
                                            <a class="nav-link" href="tabaldenotas.php">Consulta de Notas</a>
                                        </nav>
                                    </div>
                                </nav>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4  d-flex justify-content-center">Registro de Profesores</h1>
                </div>
                <div class="container">
                            ...
                            <div class="row">
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" name="phone" placeholder="Telefono" aria-label="Last name">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control" name="correo" placeholder="Correo Electronico" aria-label="Correo Electronico">
                                        </div>
                                        <div class="col">
