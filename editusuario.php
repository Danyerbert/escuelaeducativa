...
<body>
    ...
    if (isset($_POST['enviar'])) {
        ...
        $sql = "UPDATE usuarios SET usuario='" . $usuario . "', password='" . $pass_c . "', cargo='" . $cargo . "', tipo_usuario='" . $tipo_usuario . "'";
        $resultado = mysqli_query($conex, $sql);
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" class="form-control" name="usuario" placeholder="usuario" aria-label="First name" value="<?php echo $usuario; ?>">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" class="form-control" name="password" placeholder="Contraseña" aria-label="First name" value="<?php echo $pass_c; ?>">
                                            </div>
                                        </div>
                                        <br>
                                        <div class=" row">
                                            <div class="col">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-select" name="cargo" id="inputGroupSelect01">
                                                        <option selected disabled><?php echo $cargo; ?></option>
                                            ...
                                            <div class="col">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-select" name="tipo_usuario" id="inputGroupSelect01">
                                                        <option selected disabled><?php echo $tipo_usuario; ?></option>
