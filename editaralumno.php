...
<body>
    ...
    if (isset($_POST['enviar'])) {
        ...
        $id = htmlspecialchars($_POST['id_alumno']);
        ...
        $cedula_escolar = htmlspecialchars($_POST['cedula_escolar']);

        $sql = "UPDATE datos_alumnos SET nombre='" . $nombre . "', apellido='" . $apellido . "', fecha_nac='" . $fecha_nac . "', grado='" . $grado . "', turno='" . $turno . "', telefono='" . $phone . "', parentesco='" . $parentesco . "', edad='" . $edad . "', cedula_estudiante='" . $cedula_escolar . "' WHERE id_alumno= ".$id ;
        $resultado = mysqli_query($conex, $sql);

        if ($resultado) {
            echo "<script>
                alert('Los cambios han sido realizados exitosamente');
                location.assign('tabladeestudiantes.php');
            </script>";
        } else {
            echo "<script>
        ...
        $id = $_GET['id'];
        $conex = $mysqli;
        $sql = "SELECT * FROM datos_alumnos WHERE id_alumno='" . $id . "'";
        $resultado = mysqli_query($conex, $sql);
        ...
        $edad = $row['edad'];
        $cedula_escolar = $row['cedula_estudiante'];
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" class="form-control" name="cedula_escolar" placeholder="Cedula o Cedula Escolar" aria-label="First name" value="<?php echo $cedula_escolar;  ?>>">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <input type="text" class="form-control" name="apellido" placeholder="Apellido" aria-label="Last name" value="<?php echo $apellido; ?>">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col">
                                                <input type="date" class="form-control" name="fecha_nac" placeholder="Fecha de Nacimiento" aria-label="Fecha de nacimiento" value="<?php echo $fecha_nac; ?>">
                                            </div>
                                            <div class="col">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-select" name="grado" id="inputGroupSelect01">
                                                        <option value="<?php echo $turno; ?>"><?php echo $grado; ?></option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <input type="text" class="form-control" name="phone" placeholder="Telefono" aria-label="Phone" value="<?php echo $phone; ?>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-select" name="parentesco" id="inputGroupSelect01">
                                                        <option value="<?php echo $parentesco; ?>"></option>
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="number" class="form-control" name="edad" placeholder="Edad del niñ@" aria-label="Phone" value="<?php echo $edad; ?>">
